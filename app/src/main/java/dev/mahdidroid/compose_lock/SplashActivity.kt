...
class SplashActivity : BaseSplashActivity() {
    ...
    override fun getSingleTheme(): LockTheme? = LockTheme(
        PinEntryData(
    ...
    override fun getLightTheme(): LockTheme? {
        return null
    }

    override fun getDarkTheme(): LockTheme? {
        return null
    }
    ...
    override fun getDestinationClass(): Class<*> = MainComponentActivity::class.java
}